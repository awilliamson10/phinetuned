...
ggml-cuda.o: ggml/ggml-cuda.cu ggml/ggml-cuda.h
...
ggml-opencl.o: ggml/ggml-opencl.cpp ggml/ggml-opencl.h
	$(CXX) $(CXXFLAGS) -c $< -o $@
endif # LLAMA_CLBLAST
...
ifdef LLAMA_METAL
ggml-metal.o: ggml/ggml-metal.m ggml/ggml-metal.h
	$(CC) $(CFLAGS) -c $< -o $@
endif # LLAMA_METAL

ifdef LLAMA_MPI
ggml-mpi.o: ggml/ggml-mpi.c ggml/ggml-mpi.h
	$(CC) $(CFLAGS) -c $< -o $@
endif # LLAMA_MPI

GF_CC := $(CC)
include ggml/scripts/get-flags.mk
...
ggml.o: ggml/ggml.c ggml/ggml.h ggml/ggml-cuda.h
	$(CC)  $(CFLAGS)   -c $< -o $@

ggml-alloc.o: ggml/ggml-alloc.c ggml/ggml.h ggml/ggml-alloc.h
	$(CC)  $(CFLAGS)   -c $< -o $@

ggml-backend.o: ggml/ggml-backend.c ggml/ggml.h ggml/ggml-backend.h
	$(CC)  $(CFLAGS)   -c $< -o $@

ggml-quants.o: ggml/ggml-quants.c ggml/ggml.h ggml/ggml-quants.h
	$(CC) $(CFLAGS)    -c $< -o $@

OBJS += ggml-alloc.o ggml-backend.o ggml-quants.o

llama.o: ggml/llama.cpp ggml/ggml.h ggml/ggml-alloc.h ggml/ggml-backend.h ggml/ggml-cuda.h ggml/ggml-metal.h ggml/llama.h
	$(CXX) $(CXXFLAGS) -c $< -o $@
...
libllama.so: ggml/llama.o ggml/ggml.o $(OBJS)
...
main: main.cpp                                  ggml/ggml.o ggml/llama.o $(COMMON_DEPS) console.o grammar-parser.o $(OBJS)
